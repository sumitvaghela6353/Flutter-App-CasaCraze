...
class Prod2Widget extends StatefulWidget {
  const Prod2Widget({Key? key}) : super(key: key);

  @override
  _Prod2WidgetState createState() => _Prod2WidgetState();
}


class _Prod2WidgetState extends State<Prod2Widget>
