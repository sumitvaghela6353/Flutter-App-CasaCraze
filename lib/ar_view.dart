...
class ScnPage extends StatefulWidget {
  const ScnPage({super.key});

  @override
  State<ScnPage> createState() => _ScnPageState();
}

class _ScnPageState extends State<ScnPage> {
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          ElevatedButton(
            onPressed: onLocalObjectClicked,
